...
const Dashboard: React.FC<DashboardProps> = ({ username, onJoinRoom, apiUrl }) => {
  ...
  return (
    <div className="min-h-screen bg-grid-pattern flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white border-4 border-slate-900 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] rounded-xl p-8 flex flex-col gap-6 transform -rotate-1 transition-all relative">
        ...
        {mode === 'MENU' && (
            <>
                ...
                <button 
                    ...
                    className="mt-2 flex items-center justify-center gap-2 text-slate-400 hover:text-rose-500 font-bold font-hand transition-colors"
                >
